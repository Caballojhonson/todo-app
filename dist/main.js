...
/* harmony import */ var date_fns__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! date-fns */ "./node_modules/date-fns/esm/getTime/index.js");


const dateTime = (() => {

	const current =  {
        day: (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.default)(new Date(), 'P'),
        time: (0,date_fns__WEBPACK_IMPORTED_MODULE_0__.default)(new Date(), 'p'),
        timestamp: (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.default)(new Date())
    } 
...
const projects = (() => {
	...
	const storeProject = (project) => {
		_storage__WEBPACK_IMPORTED_MODULE_1__.storage.localStore('project', project);
		_storage__WEBPACK_IMPORTED_MODULE_1__.storage.pushProjectsFromStorage();
	};
...
const tasks = (() => {
	...
	const saveTask = (task) => {
		_storage__WEBPACK_IMPORTED_MODULE_1__.storage.localStore('task', task);
		_storage__WEBPACK_IMPORTED_MODULE_1__.storage.pushTasksFromStorage();
	};
...
/*!**********************!*\
  ...
  \**********************/
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _modules_objects__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./modules/objects */ "./src/modules/objects.js");
