	...
	const overview = (() => {
		const renderUpcoming = () => {
			...
			for (let i = 0; i < _logic__WEBPACK_IMPORTED_MODULE_9__.logic.getUpcomingTasks().length; i++) {
				...
				_logic__WEBPACK_IMPORTED_MODULE_9__.logic.changePriorityColor(_logic__WEBPACK_IMPORTED_MODULE_9__.logic.getUpcomingTasks()[i], priorityBox);
...
const logic = (() => {
	const sortByDeadline = () => {
		return _storage__WEBPACK_IMPORTED_MODULE_1__.storage.tasks.sort((a, b) =>
	...
	const countStats = () => {
		...
		for (let i = 0; i < _storage__WEBPACK_IMPORTED_MODULE_1__.storage.tasks.length; i++) {
			if (_storage__WEBPACK_IMPORTED_MODULE_1__.storage.tasks[i].complete === false) {
				pendingTasks.push(_storage__WEBPACK_IMPORTED_MODULE_1__.storage.tasks[i]);
			} else if (_storage__WEBPACK_IMPORTED_MODULE_1__.storage.tasks[i].complete === true) {
				completedTasks.push(_storage__WEBPACK_IMPORTED_MODULE_1__.storage.tasks[i]);
			}
		}

		for (let i = 0; i < _storage__WEBPACK_IMPORTED_MODULE_1__.storage.projects.length; i++) {
			if (_storage__WEBPACK_IMPORTED_MODULE_1__.storage.projects[i].complete === false) {
				pendingProjects.push(_storage__WEBPACK_IMPORTED_MODULE_1__.storage.projects[i]);
			} else if (_storage__WEBPACK_IMPORTED_MODULE_1__.storage.projects[i] === true) {
				completedProjects.push(_storage__WEBPACK_IMPORTED_MODULE_1__.storage.projects[i]);
			}
		}
