...
const dateTime = (() => {
	...
	const current = {
		...
		timestamp: (0,date_fns__WEBPACK_IMPORTED_MODULE_1__.default)(now()),
	};
...
function makeDummys() {
(0,_modules_objects__WEBPACK_IMPORTED_MODULE_1__.createTask)('testTitle2', 'testDesc2', '10/3/2007', 2);
(0,_modules_objects__WEBPACK_IMPORTED_MODULE_1__.createTask)('testTitle', 'testDesc', '10/3/2006', 1);

const testTask2 = _modules_storage__WEBPACK_IMPORTED_MODULE_2__.storage.tasks[0];
const testTask = _modules_storage__WEBPACK_IMPORTED_MODULE_2__.storage.tasks[1];

(0,_modules_objects__WEBPACK_IMPORTED_MODULE_1__.createProject)('third ', 'desc')
;(0,_modules_objects__WEBPACK_IMPORTED_MODULE_1__.createProject)('anocher prochecht', 'And the description')
;(0,_modules_objects__WEBPACK_IMPORTED_MODULE_1__.createProject)('Project2', 'This is a description');
_modules_storage__WEBPACK_IMPORTED_MODULE_2__.storage.projects[0].tasks.push(testTask, testTask2)

;(0,_modules_objects__WEBPACK_IMPORTED_MODULE_1__.createNote)('Note to self', 'Dont fart in public');
}
...
console.log(_modules_dateTime__WEBPACK_IMPORTED_MODULE_0__.dateTime.thisMonth);
