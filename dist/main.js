...
function makeDummys() {
(0,_modules_objects__WEBPACK_IMPORTED_MODULE_0__.createTask)('testTitle2', 'testDesc2', '10/3/2007', 2);
(0,_modules_objects__WEBPACK_IMPORTED_MODULE_0__.createTask)('testTitle', 'testDesc', '10/3/2006', 1);

const testTask2 = _modules_storage__WEBPACK_IMPORTED_MODULE_1__.storage.tasks[0];
const testTask = _modules_storage__WEBPACK_IMPORTED_MODULE_1__.storage.tasks[1];

(0,_modules_objects__WEBPACK_IMPORTED_MODULE_0__.createProject)('third ', 'desc')
;(0,_modules_objects__WEBPACK_IMPORTED_MODULE_0__.createProject)('anocher prochecht', 'And the description')
;(0,_modules_objects__WEBPACK_IMPORTED_MODULE_0__.createProject)('Project2', 'This is a description');
_modules_storage__WEBPACK_IMPORTED_MODULE_1__.storage.projects[0].tasks.push(testTask, testTask2)

;(0,_modules_objects__WEBPACK_IMPORTED_MODULE_0__.createNote)('Note to self', 'Dont fart in public');
}



console.log('All projects:');
console.log(_modules_storage__WEBPACK_IMPORTED_MODULE_1__.storage.projects);
console.log('All tasks:');
console.log(_modules_storage__WEBPACK_IMPORTED_MODULE_1__.storage.tasks)
console.log('All notes:');
console.log(_modules_storage__WEBPACK_IMPORTED_MODULE_1__.storage.notes);
