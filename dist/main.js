	...
	const eventHandling = (() => {
		...
		addNewProject.addEventListener('click', () => {
			...
			projects.renderProjects();
				console.log(_storage__WEBPACK_IMPORTED_MODULE_10__.storage.projects);
...
if(_modules_storage__WEBPACK_IMPORTED_MODULE_4__.storage.projects.length === 0) setTimeout(() => _modules_storage__WEBPACK_IMPORTED_MODULE_4__.storage.loadArrays(), 0);
setTimeout(() => debug(), 50);
...
if (_modules_storage__WEBPACK_IMPORTED_MODULE_4__.storage.tasks.length > 0) setTimeout(
